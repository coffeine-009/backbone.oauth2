...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Set extension into backbone namespace.
	 *
	 * @type {OAuth2}
	 */
	/**
	 ...
	 *
	 * @date 09/04/2016 8:49 AM
	 */
	
	_backbone2.default.OAuth2 = _oauth2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OAuth2 = function (_Model) {
	    ...
	    function OAuth2(attributes, options) {
	         ...
	         */
	        var hasLocalStorageSupport = function hasLocalStorageSupport() {
	            try {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (OAuth2.__proto__ || (0, _getPrototypeOf2.default)(OAuth2)).call(this, arguments));
	
	        _this.set('auth', _this.isAuthenticated());
	        return _this;
	    }
	    ...
	    (0, _createClass3.default)(OAuth2, [{
	        ...
	        key: 'setClientSecret',
	        value: function setClientSecret(secret) {
	        ...
	        key: 'getNormalizedTokenType',
	        value: function getNormalizedTokenType(str) {
	        ...
	        value: function save(state) {
	            // Save
	            this.state = state;
	            this.storage.setItem(this.STORAGE_KEY, (0, _stringify2.default)(state));
	        ...
	        value: function access(code, redirectUrl) {
	            ...
	            Backbone.ajax({
	                ...
	                success: function success(response) {
	                    ...
	                    _this2.save(response);
	                    _this2.trigger('success', response, _this2);
	                },
	                ...
	                error: function error(response) {
	                    _this2.trigger('error', _this2, response, _this2.options);
	                }
	            });
	        }
	        ...
	        value: function refresh() {
	            ...
	            Backbone.ajax({
	                ...
	                success: function success(response) {
	                    ...
	                    _this3.save(response);
	                    _this3.trigger('refresh', response, _this3);
	                },
	                 ...
	                 */
	                error: function error(response) {
	                    _this3.trigger('failure', _this3, response, _this3.options);
	                }
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(92), __webpack_require__(93), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
